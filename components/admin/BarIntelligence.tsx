            ...
            <div className="relative z-10 space-y-10">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black uppercase tracking-tighter">Bar Daily Brief</h2>
                            <p className="text-[9px] font-black text-primary uppercase tracking-[0.4em] mt-1">Mixology Co-Pilot Active</p>
                        </div>
                    </div>
