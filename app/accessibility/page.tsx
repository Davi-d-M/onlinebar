    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 text-left">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="space-y-8 text-sm text-slate-600 leading-relaxed text-left">
          ...
          {/* Section 1 */}
          <section>
            <h2 className="text-lg font-bold text-foreground mb-3 uppercase tracking-tight">1. Our Commitment</h2>
            <p>
              We believe that premium beverages and snacks should be accessible to everyone. Our goal is to make our storefront fully compatible with assistive technologies such as screen readers, voice recognition software, and keyboard-only navigation. We measure our platform compliance against the World Wide Web Consortium (W3C) Web Content Accessibility Guidelines (WCAG) 2.1 Level AA standards.
            </p>
          </section>
          ...
          <section className="p-5 bg-slate-50 border border-slate-200 rounded-xl">
            ...
            <p className="text-xs leading-relaxed text-slate-600 mb-3 italic">
            ...
            <ul className="list-disc pl-5 space-y-2 text-xs text-slate-600">
              ...
              <li><strong>Keyboard Navigation:</strong> Interactive components, menu links, and checkout steps are completely navigable using standard keyboard inputs.</li>
          ...
          {/* Section 3 */}
          <section>
            <h2 className="text-lg font-bold text-foreground mb-3 uppercase tracking-tight">2. Supported Specifications</h2>
            <p>
              The Online Bar storefront relies on modern web protocols to function optimally with your operating system&apos;s native accessibility settings and browser extensions:
            </p>
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-lg font-bold text-foreground mb-3 uppercase tracking-tight">3. Ongoing Improvements</h2>
            <p>
              While we strive to maintain comprehensive accessibility across our entire menu, checkout screens, and profile management blocks, some legacy pages or third-party integrations (like embedded maps or external payment trackers) may occasionally experience friction. We actively monitor and refactor our codebase to identify and fix these limitations.
            </p>
          </section>

          {/* Section 5 */}
          <section>
            <h2 className="text-lg font-bold text-foreground mb-3 uppercase tracking-tight">4. Feedback & Contact</h2>
            <p className="mb-3">
              We welcome your feedback on the accessibility of Online Bar. If you encounter any accessibility barriers while browsing our menu or completing a purchase, please let us know immediately so we can fix it:
            </p>
