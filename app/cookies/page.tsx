      ...
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="border-b pb-6 mb-8">
          ...
          <p className="text-slate-600 mt-4 leading-relaxed font-medium">
            At <strong>Online Bar</strong>, we believe in being completely clear and transparent about how we collect and process data. This Cookie Policy explains what cookies are, how we use them on our storefront, and how you can manage your preferences.
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p className="font-medium text-slate-500">
              Cookies are small, harmless text files placed on your computer or mobile device by websites that you visit. They are widely used to make web platforms function correctly, allow users to navigate smoothly between beverage categories, and remember system choices (like item arrays or local configurations).
            </p>
          </section>

          {/* Section 2 - THE ESSENTIAL FUNCTIONALITY WARNING */}
          <section className="p-5 bg-indigo-50 border border-indigo-100 rounded-xl">
            <h2 className="text-sm font-bold text-indigo-900 uppercase tracking-wider mb-2">🛒 Why Cookies Matter for Your Order</h2>
            <p className="text-xs leading-relaxed text-indigo-800 font-medium">
              Without cookies active, an online e-commerce shop cannot function. Our application uses <strong>Essential Session Cookies</strong> to keep track of your selected bottles as you browse our collections. If you disable cookies in your browser settings, your bag items will automatically disappear whenever you refresh or switch pages, preventing you from checking out successfully.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3 font-medium text-slate-500">We use a minimal footprint of tracking objects to run our cellar showcase safely:</p>
            <ul className="list-disc pl-5 space-y-3 font-medium text-slate-500">
              ...
              <li>
                <strong>Performance Analytics:</strong> These help us look at anonymous user movement traffic patterns. They tell us which vintages or spirits are gaining the most popularity so we can restructure inventory efficiently.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="font-medium text-slate-500">
              To modify these parameters, open your browser tools menu (usually found under **Settings &gt; Privacy &gt; Cookies**). However, please remember that clearing or rejecting our necessary cookies means you will be unable to finalize your drink orders via our checkout page.
            </p>
          </section>
