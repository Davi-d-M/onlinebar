      ...
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="border-b pb-6 mb-8">
          ...
          <p className="text-slate-600 mt-4 leading-relaxed font-medium">
            Welcome to <strong>Online Bar</strong>. By accessing our platform, utilizing our services, or purchasing beverages from our menu, you explicitly agree to comply with and be bound by the following contractual terms. Please review them carefully before placing an order.
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-slate-600 leading-relaxed text-left">
          ...
          <section>
            ...
            <p className="font-medium text-slate-500">
              Online Bar operates an online beverage retail storefront providing premium spirits, wine, and late-night snacks. We reserve the right to alter, pause, update, or discontinue any product configuration, inventory batch, or website asset at any given moment without prior customer notification. Must be 18+ to order.
            </p>
          </section>
          ...
          <section className="p-5 bg-amber-50 border border-amber-200 rounded-xl">
            ...
            <p className="text-amber-800 font-bold mb-2">
              Please take extreme care to verify your desired selection and quantities carefully prior to checking out.
            </p>
            <p className="text-amber-900 font-black bg-white border border-amber-200 p-3 rounded-lg italic">
              &quot;All sales completed on Online Bar are absolute and final. Under no circumstances do we accept returns, process refunds, or offer exchanges. Goods once sold cannot be returned.&quot;
            </p>
          ...
          <section>
            ...
            <p className="font-medium text-slate-500">
              Once your transaction clears, your details are handed over to local delivery agents or dispatch riders. Delivery timelines provided during checkout are strictly structural estimates. Online Bar is not liable for field delays caused by incorrect address coordinates, unreachable phone numbers, or uncoordinated courier pickups.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-medium text-slate-500">
              All text frameworks, interface graphics, UI branding, code modules, item layouts, and unique logo configurations hosted on this platform belong entirely to <strong>Online Bar</strong>. Replicating, stealing, scraping, or reusing these assets for any commercial purpose without express written consent is strictly illegal.
            </p>
          </section>
