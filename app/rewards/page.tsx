...
const VOUCHERS = [
    { points: 500, value: 500, code_prefix: 'PREMIUM500' },
    { points: 1000, value: 1000, code_prefix: 'PREMIUM1000' },
    { points: 2500, value: 2500, code_prefix: 'PREMIUM2500' },
    { points: 5000, value: 5000, code_prefix: 'PREMIUM5000' },
];
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <header className="mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-500 font-medium max-w-md italic">&quot;Trade your battlefield points for premium beverages and store credits. No games, just gains.&quot;</p>
                    </div>
                ...
                <div className="mt-16 bg-white rounded-[3rem] p-12 text-center border-2 border-primary/10 text-foreground relative overflow-hidden group hover:border-primary/30 transition-all shadow-2xl">
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">The Bar Premium League</h2>
